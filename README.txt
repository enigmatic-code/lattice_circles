...
There is a circle listed for every n up to n = 1926 (but most of these
...
The list is composed from several methods:
  ...
  - Exhuastive search for circles with a minimum number of points
    ...
    The following searches have currently been completed:
      ...
      All minimal circles with n >  80 and r <  7495
      All minimal circles with n > 192 and r < 12320
      All minimal circles with n > 496 and r < 18171
...
circles with n < 1926, or circles with a radius less than 10,000,000,000
(or preferably, both)).
