...
There is a circle listed for every n up to n = 2404 (but most of these
...
The list is composed from several methods:
  ...
  - Exhuastive search for circles with a minimum number of points
    ...
    The following searches have currently been completed:
      ...
      All minimal circles with n >  80 and r <  7662
...
circles with n < 2405, or circles with a radius less than 18e+10 (or
preferably, both)).
