...
There is a circle listed for every n up to n = 3432 (but most of these
...
The list is composed from several methods:
  ...
  - Exhuastive search for circles with a minimum number of points
    ...
    The following searches have currently been completed:
      ...
      All minimal circles with n > 496 and r < 21806
...
circles with n < 3433, or circles with r < 2.0e+12 (or preferably,
both)).
