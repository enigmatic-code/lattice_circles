...
The list is composed from several methods:
  ...
  - Exhaustive search for circles with any number of points below a
    ...
    The following searches have currently been completed:
      ...
      All minimal circles with n > 0 and r < 4479
  ...
  - Exhaustive search for circles with a minimum number of points
    ...
    The following searches have currently been completed:
      ...
      All minimal circles with r <  4479
      ...
      All minimal circles with r < 14109 and n > 128
      All minimal circles with r < 19536 and n > 240
      All minimal circles with r < 25600 and n > 320
      All minimal circles with r < 31038 and n > 464
