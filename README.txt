...
There is a circle listed for every n up to n = 3250 (but most of these
...
The list is composed from several methods:
  ...
  - Exhuastive search for circles with a minimum number of points
    ...
    The following searches have currently been completed:
      ...
      All minimal circles with n > 496 and r < 21410
  ...
  - A list of improvements for many circles with n > 196 contributed
    by Rei Igarashi. Contributions that I have not verified are listed
...
circles with n < 3251, or circles with r < 1.7e+12 (or preferably,
both)).
