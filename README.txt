...
There is a circle listed for every n up to n = 1528 (but most of these
...
The list is composed from several methods:
  ...
  - Exhaustive search for circles with any number of points below a
    ...
    The following searches have currently been completed:
      ...
      All minimal circles with n > 0 and r < 2113
  ...
  - Exhuastive search for circles with a minimum number of points
    ...
    The following searches have currently been completed:
      ...
      All minimal circles with n >  80 and r <  7341
      All minimal circles with n > 192 and r < 12320
      All minimal circles with n > 496 and r < 18050
...
circles with n < 1501, or new circles with a radius less than
1,000,000,000 (or preferably, both)).
